                        ...
                        child: SingleChildScrollView(
                          ...
                          child: RichText(
                            textAlign: TextAlign.justify,
                              text: TextSpan(
                                children: <TextSpan>[
                                  TextSpan(text: 'Setup ⚙️\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: 'A smartphone is needed. All players should be at a '
                                      'table or in a circle so that passing the smartphone is as easy'
                                      ' as possible.\n\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'Goal 🥅\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: 'The objective of the game is to roll a 21 (Mayer) '
                                      'or to reveal a lie of the accuser.\n\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'Values 🔢\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: 'In classic Poschen, the higher value of a die'
                                  ...
                                  TextSpan(text: 'Special numbers 🎲\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: '11, 22, 33, 44, 55, 66. These are called one posch, two posch, three posch, four'
                                      ' posch, five posch and six posch. A six posch is the second highest '
                                      'number combination.\n\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'Mayer 🎲\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: 'Mayer is the number combination 21. It is the highest number '
                                      'combination and cannot be beaten.\n\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'This is how it works 💻\n', style: Theme.of(context).textTheme.overline),
                                  TextSpan(text: 'The first player starts and shakes the phone. '
                                      ...
                                      'or to reveal a lie of the accuser.\n\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'The second player now has two options 🙋:\n', style: Theme.of(context).textTheme.bodyText1),
                                  TextSpan(text: 'First - he believes the player: ✅\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'If he believes the first player, he is not allowed to check if the mentioned '
                                  ...
                                  TextSpan(text: 'Second - he does not believe the player: ❌\n', style: Theme.of(context).textTheme.bodyText2),
                                  TextSpan(text: 'If he thinks the player lied when announcing his number, he may open the glasses pocket '
